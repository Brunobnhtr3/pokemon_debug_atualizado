...
def dumpDefeatAceLines
  ...
  file_data.each_line {|line|
    if line.strip.start_with?("pbTrainerBattle") && !line.include?("pbGet(602)")
      line = Rejuv == true ? line.split("::")[1] : line.split(":")[1]
      numbattle=0
      ...
      line1= Rejuv == true ? line.split("::")[1].split("),")[0] : line.split(":")[1].split("),")[0]
      line2= Rejuv == true ? line.split("::")[2].split(")")[0] : line.split(":")[2].split(")")[0] 
      line1.gsub!("_I(","")
      line2.gsub!("_I(","")
