...
def pbDefaultMart(speech=nil,cantsell=false)
  ...
  when 1
    stock = [:POKEBALL,:POTION,:SUPERPOTION,:ANTIDOTE,:PARLYZHEAL,:AWAKENING,:ESCAPEROPE,:GOURMETTREAT,:REVERSECANDY]
  when 2..3
  ...
  when 7..10
    stock = [:POKEBALL,:GREATBALL,:ULTRABALL,:HYPERPOTION,:ULTRAPOTION,:FULLHEAL,:ESCAPEROPE,:GOURMETTREAT,:REVERSECANDY]
  when 11
    stock = [:POKEBALL,:GREATBALL,:ULTRABALL,:HYPERPOTION,:ULTRAPOTION,:MAXPOTION,:FULLHEAL,:ESCAPEROPE,:GOURMETTREAT,:REVERSECANDY]
  when 12
