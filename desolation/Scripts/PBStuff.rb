...
###--------------------------------------SCREENMOVE-------------------------------------------------------------###
SCREENMOVE = [:LIGHTSCREEN, :REFLECT, :AURORAVEIL, :BADDYBAD, :GLITZYGLOW]
...
POKEMONTOMEGASTONE = {
  ...
  :GENGAR     => [:GENGARITE],      :GYARADOS   => [:GYARADOSITE],
  ...
  :SCIZOR     => [:SCIZORITE],      :TYRANITAR  => [:TYRANITARITE],
  :BEEDRILL   => [:BEEDRILLITE],    :PIDGEOT    => [:PIDGEOTITE],
  :SLOWBRO    => [:SLOWBRONITE],    :STEELIX    => [:STEELIXITE],
  :SCEPTILE   => [:SCEPTILITE],     :SWAMPERT   => [:SWAMPERTITE],
  :SHARPEDO   => [:SHARPEDONITE],   :SABLEYE    => [:SABLENITE],
  :CAMERUPT   => [:CAMERUPTITE],    :ALTARIA    => [:ALTARIANITE],
  :GLALIE     => [:GLALITITE],      :SALAMENCE  => [:SALAMENCITE],
  :METAGROSS  => [:METAGROSSITE],   :LOPUNNY    => [:LOPUNNITE],
  :GALLADE    => [:GALLADITE],      :AUDINO     => [:AUDINITE],
  :DIANCIE    => [:DIANCITE],       :TANGROWTH  => [:PULSEHOLD],
